...
export function add(params) {
  return async (dispatch, getState) => {
    ...
    try {
      const response = await api.postMultipart("/photo", params);
...
export function loadOne(id) {
  return async (dispatch, getState) => {
    ...
    try {
      ...
      dispatch({
        type: types.PHOTO_LOAD_DETAIL,
        detail: response.photo,
...
export function update(params) {
  return async (dispatch, getState) => {
    ...
    try {
      const response = await api.putMultipart("/photo", params);
...
export function loadTag() {
  return async (dispatch, getState) => {
    try {
      ...
      dispatch({
        type: types.PHOTO_REFER_TAG_LOAD_LIST,
        list: list,
        count,
        pagingRowCount,
      });
